...
def create_parser(required_true=True):
    ...
    parser.add_argument("--depth-model", type=str, default="ZoeD_Any_N",
                        choices=["ZoeD_N", "ZoeD_K", "ZoeD_NK",
                                 ...
                                 # ADR-147: real, confirmed gap -- these 4 (ADR-135) were
                                 # never added here, so `python -m iw3 --depth-model
                                 # Any_V3_Large_1_1 ...` (and the other 3) always failed
                                 ...
                                 "Any_V3_Giant", "Any_V3_Nested_Giant_Large",
                                 "DepthPro", "DepthPro_S",
                                 "VDA_S", "VDA_B", "VDA_L",
